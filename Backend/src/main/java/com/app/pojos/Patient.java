...
public class Patient extends BaseEntity {
	...
	public Patient(String name, String password, String address, String primary_phoneNo, String alt_phoneNo, LocalDate dob,
		String gender, String blood_grp, String email) {
	super();
	this.name = name;
	...
	public String toString() {
		return "Patient [name=" + name + ", password=" + password + ", address=" + address + ", primary_phoneNo="
				+ primary_phoneNo + ", alt_phoneNo=" + alt_phoneNo + ", dob=" + dob + ", gender=" + gender
				+ ", blood_grp=" + blood_grp + ", email=" + email + "]";
	}
